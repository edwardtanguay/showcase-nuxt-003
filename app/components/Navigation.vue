...
import { ref } from 'vue'
import { HomeIcon, UserIcon, BriefcaseIcon, Bars3Icon, XMarkIcon, SunIcon, MoonIcon, ClipboardDocumentListIcon, InformationCircleIcon, BoltIcon, UserGroupIcon } from '@heroicons/vue/24/outline'
